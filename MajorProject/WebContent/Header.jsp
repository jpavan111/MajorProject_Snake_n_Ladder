...
<title>Snake_&_Ladder</title>
<meta charset="utf-8">
<meta name="viewport"
	content="width=device-width, initial-scale=1, shrink-to-fit=no">

<link rel="icon" href="siteLogo.jpg" type="image/gif">
		...
		<nav class="navbar navbar-expand-lg" id="header-color">
			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav ml-auto d-flex justify-content-end align-items-center">
					...
					<li class="nav-item mr-3"><a class="nav-link" href="GameInstructions.jsp">
							<i class="fa fa-table" aria-hidden="true"></i> Instructions</a>
					</li>
					<li class="nav-item  mr-3"><a class="nav-link" href="leaderBoard.jsp">
						<i class="fa fa-table" aria-hidden="true"></i> Leader board</a>
					</li>
					<li class="nav-item  mr-3"><a class="nav-link" href="AboutUs.jsp">
						<i class="fa fa-table" aria-hidden="true"></i> About Us</a>
					</li>
					
					<li>
						<button style="size: size: 0%;width: 76px;" class="btn" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span class="navbar-text p-0"><i class='fas fa-user-tie' style='font-size:21px; color:white'>&nbsp; ${playerObject.getUsername()}</i></span>
						</button>
<!-- 						<span class="d-flex justify-content-center align-items-center" style='color: white'></span> -->
						
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="margin-left: 89.5%; background-color: #ffffffc2;">
